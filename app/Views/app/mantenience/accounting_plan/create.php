...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <span class="titulo-header-card"><a href="<?= base_url('app/mantenience/accounting_plan/index') ?>" class="link-titulo">Plan Contable</a> / Nuevo <button type="button" class="btn btn-primary btn-sm float-end" onclick="submit()">Guardar</button></span>
        </div>
        <div class="card-body">
            <div>
                <form id="form" class="mt-3" method="POST" action="<?= base_url('app/mantenience/accounting_plan/save') ?>" onsubmit="return verificarFormulario()">
                    <input type="hidden" name="CodEmpresa" value="<?= $_COOKIE['empresa'] ?>" />
                    <input type="hidden" name="Periodo" value="<?= date('Y') ?>" />
                    <input type="hidden" name="CuentaAjuste" value="" />
                    ...
                    <div class="container-fluid my-3">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8">
                                        <input type="text" name="CodCuenta" id="CodCuenta" class="form-control form-control-sm" oninput="getCuentaPadre()" onkeypress="esNumero(event)">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8">
                                        <input type="text" name="CuentaPadre" id="CuentaPadre" class="form-control form-control-sm" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-10 col-xl-10">
                                        <input type="text" name="DescCuenta" id="DescCuenta" class="form-control form-control-sm">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-1">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8">
                                        <input type="checkbox" name="AjusteDC" id="AjusteDC" value="0" onchange="mostrarAjusteDC()"> <label for="AjusteDC">Ajuste por diferencia de cambio</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-1">
                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <input type="checkbox" id="Amarres" onchange="mostrarTablaAmarres()"> <label for="Amarres">Amarres</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-1">
                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 d-none" id="columnaAmarres">
                                <div class="row mb-3">
                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 my-5" id="columnaAmarresVacio">&nbsp;</div>
                        </div>
                        <!-- <div class="row mt-1">
                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                <div class="row">
                                                        ...
                                                        <div class="table-responsive-md">
                                                            <table class="table table-sm table-bordered" id="tablaCodigos" width="100%" cellspacing="0">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <input type="text" name="CodCuentaEquiv" class="form-control form-control-sm" />
                                                                        </td>
                                                                        <td>
