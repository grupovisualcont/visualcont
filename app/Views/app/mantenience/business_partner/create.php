...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <span class="titulo-header-card"><a href="<?= base_url('app/mantenience/business_partner/index') ?>" class="link-titulo">Socio de Negocio</a> / Nuevo <button type="button" class="btn btn-primary btn-sm float-end" onclick="submit()">Guardar</button></span>
        </div>
        <div class="card-body">
            <div>
                ...
                <form id="form" class="mt-3" method="POST" action="<?= base_url('app/mantenience/business_partner/save') ?>" onsubmit="return verificarFormulario()">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8">
                                                <div class="input-group input-group-sm input-group-vc">
                                                    <input type="text" name="fecingreso" class="form-control form-control-sm mydatepicker" placeholder="dd/mm/yyyy" value="<?= date('d/m/Y') ?>" readonly>
